...
# when the Done button is clicked, the memory is saved in a .pickle file
	...
	def save_memory(self):
		...
		# fonctionnement :
		memory_params["taille"] =  int(self.entry_taille.get())
		memory_params["octets_instruction"] =  int(self.entry_octets_intruction.get())
		memory_params["freq_spi"] =  int(self.entry_freq_spi.get())
		memory_params["octets_ecriture"] =  int(self.entry_octets_ecriture.get())
		memory_params["duree_ecriture"] =  int(self.entry_duree_ecriture.get())
		memory_params["octets_lecture"] =  int(self.entry_octets_lecture.get())
		memory_params["duree_lecture"] =  int(self.entry_duree_lecture.get())
		memory_params["octets_effacement"] =  int(self.entry_octets_effacement.get())
		memory_params["duree_effacement"] =  int(self.entry_duree_effacement.get())
		# transitions :
		memory_params["trans_basse1_actif"] =  int(self.entry_trans_basse1_actif.get())
		memory_params["trans_actif_basse1"] =  int(self.entry_trans_actif_basse1.get())
		memory_params["trans_basse2_actif"] =  int(self.entry_trans_basse2_actif.get())
		memory_params["trans_actif_basse2"] =  int(self.entry_trans_actif_basse2.get())
		# consommation : 
		memory_params["conso_actif"] =  int(self.entry_conso_actif.get())
		memory_params["conso_ecriture"] =  int(self.entry_conso_ecriture.get())
		memory_params["conso_lecture"] =  int(self.entry_conso_lecture.get())
		memory_params["conso_effacement"] =  int(self.entry_conso_effacement.get())
		memory_params["conso_basse1"] =  int(self.entry_conso_basse1.get())
		memory_params["conso_basse2"] =  int(self.entry_conso_basse2.get())
