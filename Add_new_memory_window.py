...
# when the Done button is clicked, the memory is saved in a .pickle file
	...
	def init_central_frame(self):
		# text
		text = "Please enter the new memory parameters"
	...
	def save_memory(self):
		...
		# fonctionnement :
		memory_params["taille"] =  float(self.entry_taille.get())
		memory_params["octets_instruction"] =  float(self.entry_octets_intruction.get())
		memory_params["freq_spi"] =  float(self.entry_freq_spi.get())
		memory_params["octets_ecriture"] =  float(self.entry_octets_ecriture.get())
		memory_params["duree_ecriture"] =  float(self.entry_duree_ecriture.get())
		memory_params["octets_lecture"] =  float(self.entry_octets_lecture.get())
		memory_params["duree_lecture"] =  float(self.entry_duree_lecture.get())
		memory_params["octets_effacement"] =  float(self.entry_octets_effacement.get())
		memory_params["duree_effacement"] =  float(self.entry_duree_effacement.get())
		# transitions :
		memory_params["trans_basse1_actif"] =  float(self.entry_trans_basse1_actif.get())
		memory_params["trans_actif_basse1"] =  float(self.entry_trans_actif_basse1.get())
		memory_params["trans_basse2_actif"] =  float(self.entry_trans_basse2_actif.get())
		memory_params["trans_actif_basse2"] =  float(self.entry_trans_actif_basse2.get())
		# consommation : 
		memory_params["conso_actif"] =  float(self.entry_conso_actif.get())
		memory_params["conso_ecriture"] =  float(self.entry_conso_ecriture.get())
		memory_params["conso_lecture"] =  float(self.entry_conso_lecture.get())
		memory_params["conso_effacement"] =  float(self.entry_conso_effacement.get())
		memory_params["conso_basse1"] =  float(self.entry_conso_basse1.get())
		memory_params["conso_basse2"] =  float(self.entry_conso_basse2.get())
